...
const STRINGS = {
  ...
  'game.explain.role': { uk: '{muscle} тут — {role}.', en: '{muscle} is the {role} here.' },
  'game.explain.absent': { uk: '{muscle} у цій вправі не працює.', en: '{muscle} does not work in this exercise.' },
